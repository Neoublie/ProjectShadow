...
public class BlockOreTin extends BlockOres {

	public BlockOreTin(Material material, String unlocalizedName, String registryName) {
    ...
    {
        return ProjectShadowItems.CHUNK_TIN;
    }
    @Override

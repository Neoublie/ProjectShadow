...
public class BlockOreIron extends BlockOres {

	public BlockOreIron(Material material, String unlocalizedName, String registryName) {
    ...
    {
        return ProjectShadowItems.CHUNK_IRON;
    }
    @Override

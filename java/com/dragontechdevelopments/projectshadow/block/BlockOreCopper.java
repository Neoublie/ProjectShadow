...
public class BlockOreCopper extends BlockOres{

	public BlockOreCopper(Material material, String unlocalizedName, String registryName) {
    ...
    {
        return ProjectShadowItems.CHUNK_COPPER;
    }
    @Override

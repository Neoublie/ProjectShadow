...
public class BlockOreMithril extends BlockOres{
	
	public BlockOreMithril(Material material, String unlocalizedName, String registryName) {
    ...
    {
        return ProjectShadowItems.CHUNK_MITHRIL;
    }
    @Override

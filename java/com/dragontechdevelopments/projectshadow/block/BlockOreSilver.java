...
public class BlockOreSilver extends BlockOres {

	public BlockOreSilver(Material material, String unlocalizedName, String registryName) {
    ...
    {
        return ProjectShadowItems.CHUNK_SILVER;
    }
    @Override
